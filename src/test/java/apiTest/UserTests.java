...
public class UserTests {
	...
	/*
	 * @Test(priority=4) public void testDeleteUser() { Response
	 * response=UserEndpoints.deleteUser(this.userpayload.getUsername());
	 * response.then().log().all(); Assert.assertEquals(200,
	 * response.getStatusCode()); System.out.println(response.time());
	 * System.out.println(response.getContentType()); }
	 */
}
